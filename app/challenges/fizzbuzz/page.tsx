...
import { codeString } from '../../../challengeCode/fizzBuzz';

SyntaxHighlighter.registerLanguage('typescript', ts);

const FizzBuzz = (): JSX.Element => {
	const url = 'https://rs-fizzbuzz.netlify.app/';
	const options = {
						...
						>
							...
							<section className='mb-10'>
								...
								<p className='font-secondary text-dark leading-loose'>
									Create a program that prints the numbers from 1 to 100. For
									numbers that are a multiple of 3 display Fizz, numbers that
									are a multiple of 5 display Buzz and for numbers that are a
									multiple of 3 and 5 display FizzBuzz.
								</p>
							</section>
							...
							<section className='mb-10'>
								...
								<ul className='font-secondary font-bold space-y-3'>
									...
									<li className='flex gap-2 items-center'>
										<FaCheckSquare className='text-secondary-200 text-2xl' />
										<span className='text-dark'>If/Then/Else Statements</span>
									</li>
									<li className='flex gap-2 items-center'>
										<FaCheckSquare className='text-secondary-200 text-2xl' />
										<span className='text-dark'>HTML Templating</span>
									</li>
								</ul>
							</section>
